package com.l3tplay.crashclaimmap.configuration;
...
public class Config {
    public static String CONTROL_LABEL = "CrashClaim";
    ...
    public static String CLAIM_TOOLTIP = "Claim Name: <span style=\"font-weight:bold;\">{name}</span><br/>" +
